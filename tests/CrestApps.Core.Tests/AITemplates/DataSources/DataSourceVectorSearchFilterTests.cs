...
public sealed class DataSourceVectorSearchFilterTests
{
    ...
    public void AzureAISearch_BuildODataFilter_AlwaysIncludesDataSourceId()
    {
        var serviceType = Type.GetType(
            "CrestApps.Core.Azure.AISearch.Services.AzureAISearchDataSourceContentManager, CrestApps.Core.Azure.AISearch",
            throwOnError: true);
    ...
    {
        var serviceType = Type.GetType(
            "CrestApps.Core.Elasticsearch.Services.ElasticsearchDataSourceContentManager, CrestApps.Core.Elasticsearch",
            throwOnError: true);
