...
public sealed class AITemplateBuilderTests
{
    ...
    {
        var service = new FakeAITemplateService(new Dictionary<string, string> { ["greeting"] = "Hello from template!", });
        var builder = new TemplateBuilder();
        builder.WithSeparator("\n");
    ...
    {
        var service = new FakeAITemplateService(new Dictionary<string, string> { ["t1"] = "Rendered with args", });
    ...
    {
        var result = new TemplateBuilder().WithSeparator(" ").Append("A").Append("B").Append("C").Build();
