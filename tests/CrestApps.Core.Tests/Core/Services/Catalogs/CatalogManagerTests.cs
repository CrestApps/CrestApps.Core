...
public sealed class CatalogManagerTests
{
    ...
    {
        records ??= [];
        var catalog = InMemoryCatalogFactory.CreateCatalog(records);
    ...
    public async Task FindByIdAsync_ReturnsEntry_WhenExists()
    {
        ...
        var result = await manager.FindByIdAsync("1", CancellationToken);
    ...
    public async Task FindByIdAsync_ReturnsNull_WhenNotExists()
    {
        ...
        var result = await manager.FindByIdAsync("notfound", CancellationToken);
    ...
    public async Task CreateAsync_AddsEntry()
    {
        ...
        var result = await manager.FindByIdAsync("new", CancellationToken);
    ...
    public async Task UpdateAsync_UpdatesEntry()
    {
        ...
        await manager.UpdateAsync(entry, cancellationToken: CancellationToken);
    ...
    public async Task DeleteAsync_RemovesEntry_WhenExists()
    {
        ...
        var result = await manager.DeleteAsync(entry, CancellationToken);

        Assert.True(result);

        var deleted = await manager.FindByIdAsync("1", CancellationToken);
    ...
    public async Task GetAllAsync_ReturnsAllEntries()
    {
        ...
        var result = await manager.GetAllAsync(CancellationToken);
    ...
    public async Task PageAsync_ReturnsPagedResults()
    {
        ...
        var result = await manager.PageAsync(2, 3, context, CancellationToken);
    ...
    public async Task DeleteAsync_InvokesHandlersInOrder()
    {
        ...
        await manager.DeleteAsync(entry, CancellationToken);

        handlerMock.Verify(h => h.DeletingAsync(It.Is<DeletingContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
        handlerMock.Verify(h => h.DeletedAsync(It.Is<DeletedContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task DeleteAsync_DeletesWithoutCallingCommit()
    {
        ...
        catalogMock
            .Setup(catalog => catalog.DeleteAsync(entry, It.IsAny<CancellationToken>()))
            .ReturnsAsync(true);
        ...
        catalogMock.Verify(catalog => catalog.DeleteAsync(entry, It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task CreateAsync_InvokesHandlersInOrder()
    {
        ...
        handlerMock.Verify(h => h.CreatingAsync(It.Is<CreatingContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
        handlerMock.Verify(h => h.CreatedAsync(It.Is<CreatedContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task UpdateAsync_InvokesHandlersInOrder()
    {
        ...
        handlerMock.Verify(h => h.UpdatingAsync(It.Is<UpdatingContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
        handlerMock.Verify(h => h.UpdatedAsync(It.Is<UpdatedContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task ValidateAsync_InvokesHandlersInOrder()
    {
        ...
        await manager.ValidateAsync(entry, CancellationToken);

        handlerMock.Verify(h => h.ValidatingAsync(It.Is<ValidatingContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
        handlerMock.Verify(h => h.ValidatedAsync(It.Is<ValidatedContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task NewAsync_InvokesHandlersInOrder()
    {
        ...
        handlerMock.Verify(h => h.InitializingAsync(It.Is<InitializingContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
        handlerMock.Verify(h => h.InitializedAsync(It.Is<InitializedContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task FindByIdAsync_InvokesLoadedHandler()
    {
        ...
        await manager.FindByIdAsync("1", CancellationToken);

        handlerMock.Verify(h => h.LoadedAsync(It.Is<LoadedContext<TestCatalogEntry>>(ctx => ctx.Model == entry), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task GetAllAsync_InvokesLoadedHandlerForEach()
    {
        ...
        handlerMock.Verify(h => h.LoadedAsync(It.IsAny<LoadedContext<TestCatalogEntry>>(), It.IsAny<CancellationToken>()), Times.Exactly(2));
    }
    ...
    public async Task DeleteAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        var handler = new TestCatalogEntryHandler<TestCatalogEntry>
        {
            ...
            {
                existsInCatalogDuringDeleting = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
                callOrder.Enqueue("DeletingAsync");
            },
            OnDeletedAsync = async ctx =>
            {
                existsInCatalogDuringDeleted = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
    ...
    public async Task CreateAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        var handler = new TestCatalogEntryHandler<TestCatalogEntry>
        {
            ...
            {
                existsInCatalogDuringCreating = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) == null;
                callOrder.Enqueue("CreatingAsync");
            },
            OnCreatedAsync = async ctx =>
            {
                existsInCatalogDuringCreated = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
    ...
    public async Task UpdateAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        var handler = new TestCatalogEntryHandler<TestCatalogEntry>
        {
            ...
            {
                existsInCatalogDuringUpdating = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
                callOrder.Enqueue("UpdatingAsync");
            },
            OnUpdatedAsync = async ctx =>
            {
                existsInCatalogDuringUpdated = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
    ...
    public async Task ValidateAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        var handler = new TestCatalogEntryHandler<TestCatalogEntry>
        {
            ...
            {
                existsInCatalogDuringValidating = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
                callOrder.Enqueue("ValidatingAsync");
            },
            OnValidatedAsync = async ctx =>
            {
                existsInCatalogDuringValidated = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
    ...
    public async Task FindByIdAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        var handler = new TestCatalogEntryHandler<TestCatalogEntry>
        {
            ...
            {
                existsInCatalogDuringLoaded = await catalog.FindByIdAsync(entry.ItemId, CancellationToken) != null;
    ...
    public async Task PageAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        var catalog = InMemoryCatalogFactory.CreateCatalog(entries);
        var logger = Mock.Of<ILogger<CatalogManager<TestCatalogEntry>>>();
        var callOrder = new Queue<string>();
        ...
        await manager.PageAsync(1, 5, context, CancellationToken);
        ...
        Assert.Empty(callOrder);
        Assert.Equal(entries.Select(entry => entry.ItemId), loadedIds);
    }
    ...
    public async Task GetAllAsync_InvokesHandlersInCorrectOrderAndTiming()
    {
        ...
        [
            new TestCatalogEntry { ItemId = "1" },
            new TestCatalogEntry { ItemId = "2" },
            new TestCatalogEntry { ItemId = "3" },
        ];
