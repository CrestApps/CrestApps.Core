...
public sealed class DefaultOrchestratorResolverTests
{
    ...
    public void Resolve_RegisteredName_ReturnsCorrectOrchestrator()
    {
        ...
        options.Orchestrators["custom"] = new OrchestratorEntry
        {
            Type = typeof(TestOrchestrator)
        };
        ...
        var resolver = new DefaultOrchestratorResolver(sp, Options.Create(options), NullLogger<DefaultOrchestratorResolver>.Instance);
    ...
    {
        var options = new OrchestratorOptions();
        options.Orchestrators["Default"] = new OrchestratorEntry
        {
            Type = typeof(DefaultOrchestrator)
        };
        var services = new ServiceCollection();
        services.AddScoped<DefaultOrchestrator>();
        RegisterDependencies(services);
    ...
    {
        var options = new OrchestratorOptions();
        options.Orchestrators[DefaultOrchestrator.OrchestratorName] = new OrchestratorEntry
        {
            Type = typeof(DefaultOrchestrator)
        };
        var services = new ServiceCollection();
