...
public sealed class TabularBatchProcessor : ITabularBatchProcessor
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            var deployment = await _deploymentManager.ResolveOrDefaultAsync(AIDeploymentPurpose.Chat, deploymentName: sourceContext.ChatDeploymentName, cancellationToken: cancellationToken)
