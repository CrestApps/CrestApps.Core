...
public sealed class SearchDocumentsTool : AIFunction
{
    ...
    protected override async ValueTask<object> InvokeCoreAsync(AIFunctionArguments arguments, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var embeddingDeployment = await deploymentManager.ResolveSlotAsync(AIDeploymentSlotNames.Embedding, clientName: executionContext?.ClientName, cancellationToken: cancellationToken);
