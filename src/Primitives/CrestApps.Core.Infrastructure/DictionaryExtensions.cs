...
public static class DictionaryExtensions
{
    ...
    {
        return entry.GetStringValue("ChatDeploymentName", throwException) ?? entry.GetStringValue("DefaultChatDeploymentName", throwException) ?? entry.GetStringValue("DefaultDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetEmbeddingDeploymentName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("EmbeddingDeploymentName", throwException) ?? entry.GetStringValue("DefaultEmbeddingDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetImagesDeploymentName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("ImagesDeploymentName", throwException) ?? entry.GetStringValue("DefaultImagesDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetUtilityDeploymentName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("UtilityDeploymentName", throwException) ?? entry.GetStringValue("DefaultUtilityDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetChatDeploymentOrDefaultName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("ChatDeploymentName", false) ?? entry.GetStringValue("DeploymentName", false) ?? entry.GetStringValue("DefaultDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetEmbeddingDeploymentOrDefaultName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("EmbeddingDeploymentName", false) ?? entry.GetStringValue("DefaultEmbeddingDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetImagesDeploymentOrDefaultName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("ImagesDeploymentName", false) ?? entry.GetStringValue("DefaultImagesDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetUtilityDeploymentOrDefaultName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("UtilityDeploymentName", false) ?? entry.GetStringValue("DefaultUtilityDeploymentName", throwException);
    }

    [Obsolete("Deployment names on connections are deprecated. Use the deployment resolver instead.")]
    public static string GetSpeechToTextDeploymentName(this IDictionary<string, object> entry, bool throwException = true)
    {
        return entry.GetStringValue("SpeechToTextDeploymentName", throwException) ?? entry.GetStringValue("DefaultSpeechToTextDeploymentName", throwException);
    }
    ...
    {
        return entry.GetStringValue("SpeechToTextDeploymentName", false) ?? entry.GetStringValue("DefaultSpeechToTextDeploymentName", throwException);
    }
