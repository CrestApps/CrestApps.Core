...
public static class MemoryMetadataExtensions
{
    ...
    private static MemoryMetadata Deserialize(object value)
    {
        ...
        {
            return element.ValueKind == JsonValueKind.Null ? null : element.Deserialize<MemoryMetadata>(_serializerOptions);
        }
    ...
    {
        return properties is not null && properties.TryGetValue(key, out var value) ? value : null;
    }
}
