...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddCoreAIServicesStoresYesSql(this IServiceCollection services)
    {
        ...
        AddYesSqlSourceDocumentCatalog<AIToolDefinition, AIToolDefinitionIndex>(services, static o => o.AICollectionName);
        ...
        services.TryAddEnumerable(ServiceDescriptor.Singleton<IIndexProvider, AIToolDefinitionIndexProvider>());
