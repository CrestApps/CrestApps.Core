...
{
    public static Task CreateSearchIndexProfileIndexSchemaAsync(this ISchemaBuilder schemaBuilder, string collection = null)
    {
        return schemaBuilder.CreateMapIndexTableAsync<SearchIndexProfileIndex>(table => table
            ...
            .Column<string>(nameof(SearchIndexProfileIndex.ProviderName), column => column.WithLength(50))
