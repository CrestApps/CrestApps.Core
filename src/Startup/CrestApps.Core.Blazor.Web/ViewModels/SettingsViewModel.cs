...
public sealed class SettingsViewModel
{
    ...
    public List<KeyValuePair<string, string>> TextToSpeechDeployments { get; set; } = [];

    public List<KeyValuePair<string, string>> ChatInteractionModes { get; set; } = [];

    public List<KeyValuePair<string, string>> DocumentIndexProfiles { get; set; } = [];

    public List<KeyValuePair<string, string>> MemoryIndexProfiles { get; set; } = [];
