...
/// <summary>
/// The view model used to create and edit an AI tool instance configured from the built-in HTTP API request definition.
/// </summary>
public sealed class AIToolInstanceViewModel
{
    ...
    /// <summary>
    /// Gets or sets the tool definition name.
    /// </summary>
    public string Source { get; set; } = HttpApiRequestToolConstants.DefinitionName;
