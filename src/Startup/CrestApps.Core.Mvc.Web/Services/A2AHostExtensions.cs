...
internal static class A2AHostExtensions
{
    ...
    public static IServiceCollection AddA2AHost(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IAgentHandler, MvcA2AAgentHandler>();
    ...
    private sealed class MvcA2AAgentHandler : IAgentHandler
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MvcA2AAgentHandler(IHttpContextAccessor httpContextAccessor)
        {
