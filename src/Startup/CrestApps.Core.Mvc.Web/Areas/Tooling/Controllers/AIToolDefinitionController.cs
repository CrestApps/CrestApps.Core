...
/// <summary>
/// Manages HTTP API request tool definitions. Each instance is a preconfigured, model-invokable tool that
/// carries its own endpoint, authentication, headers, and a description used to disambiguate definitions.
/// </summary>
[Area("Tooling")]
[Authorize(Policy = "Admin")]
public sealed class AIToolDefinitionController : Controller
{
    ...
    private readonly ICatalog<AIToolDefinition> _catalog;
    private readonly IDataProtectionProvider _dataProtectionProvider;
    private readonly TimeProvider _timeProvider;

    /// <summary>
    /// Initializes a new instance of the <see cref="AIToolDefinitionController"/> class.
    /// </summary>
    /// <param name="catalog">The tool definition catalog.</param>
    ...
    public AIToolDefinitionController(
        ICatalog<AIToolDefinition> catalog,
    ...
    /// <summary>
    /// Lists all configured tool definitions.
    /// </summary>
    ...
    {
        return View(new AIToolDefinitionViewModel
        {
    ...
    public async Task<IActionResult> Create(AIToolDefinitionViewModel model)
    {
        ...
        var instance = new AIToolDefinition
        {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(AIToolDefinitionViewModel model)
    {
    ...
    private void Validate(AIToolDefinitionViewModel model, bool isEditing)
    {
    ...
    private void Apply(AIToolDefinitionViewModel model, AIToolDefinition instance)
    {
    ...
    private static AIToolDefinitionViewModel ToViewModel(AIToolDefinition instance)
    {
        var model = new AIToolDefinitionViewModel
        {
