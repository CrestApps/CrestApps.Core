...
public sealed class AIConnectionController : Controller
{
    ...
    public AIConnectionController(ICatalog<AIProviderConnection> catalog, IConfiguration configuration, MvcAIProviderOptionsStore providerOptionsStore, IOptionsMonitorCache<AIProviderOptions> providerOptionsCache)
    {
        _catalog = catalog;
    ...
    private static void AddConfiguredConnection(Dictionary<string, ConfiguredConnectionEntry> connections, string providerName, string connectionName, string displayText)
    {
