...
- keeps the docs release notes tied to the project `VersionPrefix`, so documentation-only refreshes update this `v1.0.0.md` file instead of creating an extra changelog version
