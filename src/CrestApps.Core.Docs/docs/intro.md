...
**CrestApps.Core is the AI application framework for .NET.** It is designed for teams that want to add advanced AI capabilities to an existing application without spending months rebuilding orchestration, chat, retrieval, reporting, and integration plumbing from scratch.

## What it delivers

- provider-agnostic AI management with profiles, connections, deployments, and data sources
- reusable AI profiles that define behavior, prompts, models, tools, and defaults
...
| Reusable behavior across sessions | AI profiles, templates, orchestration, and shared defaults |
...
- **[Getting Started](getting-started.md)** for build, run, and sample-host commands
