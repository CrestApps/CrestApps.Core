...
{
    /// <summary>
    /// Gets the unique technical name of the chat completion client implementation.
    ...
    IAsyncEnumerable<ChatResponseUpdate> CompleteStreamingAsync(IEnumerable<ChatMessage> messages, AICompletionContext context, CancellationToken cancellationToken = default);
}
