...
/// <see cref="AIToolInstance"/>. Passed to <see cref="IAIToolInstanceDefinition.CreateTool"/>.
/// </summary>
public sealed class AIToolInstanceToolContext
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AIToolInstanceToolContext"/> class.
    /// </summary>
    ...
    public AIToolInstanceToolContext(AIToolInstance instance, string functionName, string description)
    {
    ...
    /// multiple instances of the same definition surface as distinct callable functions.
    /// </summary>
    public string FunctionName { get; }

    /// <summary>
    /// Gets the description to expose to the AI model, taken from the instance so the model can
    /// distinguish between instances of the same definition.
    /// </summary>
